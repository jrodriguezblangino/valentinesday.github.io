document.addEventListener('DOMContentLoaded', () => {
    ...
    heart.addEventListener('click', async () => {
        if (currentPhase === 1) {
            ...
            const explosionSound = new Audio('/valentinesday.github.io/assets/sounds/cinematic-boom-171285.mp3');
            ...
            newVideo.src = '/valentinesday.github.io/assets/sounds/Corazon.mp4';
            ...
            newVideo.play().then(() => {
                ...
                setTimeout(() => {
                    newVideo.remove();
                    window.location.href = '/valentinesday.github.io/pages/homepage.html';
                }, 18000);
            }).catch(error => {
                console.error('Error reproducción:', error);
                // Fallback
                setTimeout(() => window.location.href = '/valentinesday.github.io/pages/homepage.html', 21000);
            });
        }
    });
});
