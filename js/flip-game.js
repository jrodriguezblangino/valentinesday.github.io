...
function getRandomCardBack() {
  return `/valentinesday.github.io/assets/images/cards/${cardBacks[Math.floor(Math.random() * cardBacks.length)]}`;
}
...
function createCards() {
  ...
  cardsData.forEach((card, index) => {
    ...
    img.src = `/valentinesday.github.io/assets/images/cards/${card}.jpg`;
...
function createMatchEffect(card) {
  ...
  effect.style.left = `${rect.left}px`;
  effect.style.top = `${rect.top}px`;
  effect.style.background = `url('/valentinesday.github.io/assets/images/cards/transparent-dance.gif') no-repeat center/cover`;
